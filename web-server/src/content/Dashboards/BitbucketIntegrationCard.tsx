// CLUSTOX: mirrors GitlabIntegrationCard exactly -- generated from it with
// provider identifiers swapped, so the three code-provider cards stay
// visually and behaviourally identical. If the card boilerplate ever gets
// factored into one component, fold this in with the others.
import {
